window.addEventListener('load', () => {
  ...
  const css = `.dark{color-scheme:dark}.absolute{position:absolute}.right-px{right:1px}.top-px{top:1px}.z-\\[99\\]{z-index:99}.box-border{box-sizing:border-box}.h-6{height:1.5rem}.w-6{width:1.5rem}.cursor-pointer{cursor:pointer}.select-none{-webkit-user-select:none;user-select:none}.rounded-lg{border-radius:.5rem}.bg-slate-300{--tw-bg-opacity:1;background-color:rgb(203 213 225/var(--tw-bg-opacity))}.bg-slate-700{--tw-bg-opacity:1;background-color:rgb(51 65 85/var(--tw-bg-opacity))}.fill-sky-300\\/20{fill:#7dd3fc33}.fill-slate-400{fill:#94a3b8}.stroke-slate-500{stroke:#64748b}.text-slate-500{--tw-text-opacity:1;color:rgb(100 116 139/var(--tw-text-opacity))}.outline-none{outline:2px solid #0000;outline-offset:2px}.active\\:border:active{border-width:1px}.active\\:border-solid:active{border-style:solid}.active\\:border-slate-400:active{--tw-border-opacity:1;border-color:rgb(148 163 184/var(--tw-border-opacity))}.active\\:border-slate-500:active{--tw-border-opacity:1;border-color:rgb(100 116 139/var(--tw-border-opacity))}.group:hover .group-hover\\:fill-slate-300{fill:#cbd5e1}.group:hover .group-hover\\:stroke-slate-700{stroke:#334155}`;
  ...
  button.setAttribute( 'class', 'absolute top-px right-px text-slate-500 outline-none select-none cursor-pointer z-[99]', );
